...
namespace Emeet.Infrastructure.Migrations
{
    ...
    [Migration("20250525130330_Update-Pasword in User table")]
    partial class UpdatePaswordinUsertable
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Emeet.Domain.Entities.ExService", b =>
                {
                    ...
                    b.ToTable("ex_service", (string)null);
                });
            ...
            modelBuilder.Entity("Emeet.Domain.Entities.Appointment", b =>
                {
                    ...
                    b.HasOne("Emeet.Domain.Entities.ExService", "ExService")
                        .WithMany("Appointments")
